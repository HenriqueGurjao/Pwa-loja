          ...
          <li key={Prods.id} className="m-4 ">
            <div className="w-full bg-zinc-500 rounded-xl p-4 flex justify-between text-white">
              <div className=' flex  justify-around text-white'>
                ...
                <p className='mx-24'>Quantidade: {Prods.amount}</p>              
                <p className='mx-24'>Valor final: {(Prods.amount * Prods.price).toLocaleString("pt-BR", {style: "currency", currency: "BRL"})}</p>
              ...
              <div className="flex flex-col justify-around md:flex-row ">
                ...
                <div className="mx-1 text-white text-justify">
                  <button className="border w-32 h-20  rounded-lg bg-blue-500" onClick={() => removeFromCart(Prods.id)}>
                    Remover Carrinho
                  </button>
                </div>
              </div>
